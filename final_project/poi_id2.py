...
def addFeatures():
    if ADD_NEW_FEATURE:
        ...
        my_dataset = pickle.load(open("final_project_dataset.pkl", "r"))
        return my_dataset
...
features_list = ['poi', 'total_stock_value', 'exercised_stock_options', 'bonus', 'deferred_income',
                 'long_term_incentive']
...
if FEATURE_SELECTION:
    ...
    for l in select_best_result:
        print l  ### Try a varity of classifiers
